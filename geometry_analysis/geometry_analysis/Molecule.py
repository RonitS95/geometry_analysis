...
if __name__ == "__main__":
    ...
    print(F"The NEW Coordinates are {my_molecule.coordinates}")
    print(F"There are now {len(my_molecule.bonds)} bonds")

    random_coords = np.random.random([4,4])
    my_molecule.coordinates = random_coords

    print(F"There are now {len(my_molecule.bonds)} bonds")
    print(my_molecule.num_atoms)
